...
\`Arc Lab\` does not directly use cookies. However, some third-party services we utilize, such as PostHog and Sentry, may use cookies to monitor interactions with our Service. Additionally, cookies are used to enhance user experience and functionality.
...
If you have any questions or concerns about this Privacy Policy, please feel free to contact us at [support@arclab.ai](mailto:support@arclab.ai). We will do our best to respond to your inquiries promptly.
`;
