            ...
            <Flex direction="col" className="w-full flex-1 items-start overflow-hidden">
                ...
                >
                    ...
                    {!isLoaded ? (
                        ...
                        <div className={cn(
                            'bg-background shadow-subtle-xs flex w-full flex-row items-center gap-3 rounded-lg px-2 py-1.5',
                            !isSidebarOpen && 'px-1.5'
                        )}>
                            <div className="bg-muted-foreground/20 animate-pulse flex size-5 shrink-0 items-center justify-center rounded-full">
                                <IconUser
                                    size={14}
                                    strokeWidth={2}
                            ...
                            {isSidebarOpen && (
                                <div className="bg-muted-foreground/20 animate-pulse h-4 w-20 rounded" />
                            )}
                        </div>
                    ) : isSignedIn ? (
                        <DropdownMenu>
